    ...
    <div className="licencia-contenedor">
      ...
      <div className="comprobante-contenedor">
        <div className="comprobante-header">
          <div className="comprobante-titulo">COMPROBANTE</div>
          <div className="comprobante-fecha">{fechaHoraActual}</div>
        </div>
          
          <hr />

          <div className="comprobante-t"><b>DATOS DEL USUARIO </b></div>
          ...
          <div className="comprobante-t"><b>DATOS DE LA LICENCIA </b></div>
          ...
          <div className="comprobante-dato"><b>Costo:</b> ${titular.comprobanteDTO.costo}</div>
